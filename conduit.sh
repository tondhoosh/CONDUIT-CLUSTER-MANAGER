...
#
# +-------------------------------------------------------------------+
# |         PSIPHON CONDUIT MANAGER 2.5-iran-ipv6                     |
# |                                                                   |
        ...
        if [ "$idle_time" -ge "$STUCK_THRESHOLD" ]; then
            ...
            if docker restart "$cname" >/dev/null 2>&1; then
                ...
                if [ "$TELEGRAM_ENABLED" = "true" ] && [ -n "$TELEGRAM_BOT_TOKEN" ] && [ -n "$TELEGRAM_CHAT_ID" ]; then
                    ...
                    telegram_send_message "???????????????????????? *Conduit Alert*
...
No Conduit containers are running\\!"
    ...
    if [ "$total_peers" -eq 0 ] 2>/dev/null; then
        if [ "$zero_peers_since" -eq 0 ] 2>/dev/null; then
            ...
            telegram_send "???????????????????????? *Alert: Zero peers*
...
show_settings_menu() {
    ...
    while true; do
        if [ "$redraw" = true ]; then
            ...
            echo -e "${CYAN}??????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????${NC}"
            echo -e "  1. ???????????????????????????  Change settings (max-clients, bandwidth)"
            echo -e "  2. ??????????????????? Set data usage cap"
            echo -e "  l. ????????????????????????????????  Set resource limits (CPU, memory)"
            echo ""
...
SVCEOF
    ...
    while true; do
        if [ "$redraw" = true ]; then
            ...
            echo -e "  7. ????????????????????????????  Scale Cluster"
            echo -e "  8. ???????????????????????????  Cluster Operations (Start/Stop/Restart)"
            echo ""
            echo -e "  9. ???????????????????????????????  Settings & Tools"
            echo -e "  i. ???????????????????????????  Info & Help"
            echo -e "  0. ???????????????? Exit"
            echo -e "${CYAN}??????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????${NC}"
            echo ""
        ...
        case "$choice" in
            ...
            8)
                echo ""
                echo -e "  1. ????????????????????????????  Start Cluster"
                echo -e "  2. ????????????????????????  Stop Cluster"
